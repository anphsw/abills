  ...
  var b = function () {
    ...
    return function () {
      ...
      return b.Extend(d, b.Observable), d.prototype.render = function () {
        ...
        if (this.$element && this.$element.parent() && this.$element.parent().hasClass('select2-append')) c.addClass('select2-with-append');
      ...
      return b.Extend(d, a), d.prototype.current = function (a) {
        ...
        this.$element.children().each(function () {
          var b = c(this);
          if ((b.is("option") && b.css('display') != 'none') || b.is("optgroup")) {
