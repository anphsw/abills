  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav" id="dw__navbar">
        <li>
  <a href="/wiki/doku.php/abills" ><i class="fa fa-home"></i> Home</a></li>
      </ul>
...
<ul class="nav navbar-nav" id="dw__tools">
  ...
  <li class="dropdown">
    ...
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="">
      <i class="fa fa-wrench"></i> <span class="hidden-lg hidden-md hidden-sm">Инструменты</span> <span class="caret"></span>
    </a>

    <ul class="dropdown-menu tools" role="menu">
    
      <li class="dropdown-header">
        <i class="fa fa-user"></i> Инструменты пользователя      </li>
      
            <li class="divider"></li>
      
    
      <li class="dropdown-header">
        <i class="fa fa-wrench"></i> Инструменты сайта      </li>
      <li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=recent"  class="action recent" accesskey="r" rel="nofollow" title="Недавние изменения [R]"><i class="fa fa-list-alt"></i> Недавние изменения</a></li><li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=media&amp;ns=abills%3Adocs_03%3Ainstall"  class="action media" rel="nofollow" title="Управление медиафайлами"><i class="fa fa-picture-o"></i> Управление медиафайлами</a></li><li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=index"  class="action index" accesskey="x" rel="nofollow" title="Все страницы [X]"><i class="fa fa-sitemap"></i> Все страницы</a></li>
            <li class="divider"></li>
      
    
      <li class="dropdown-header">
        <i class="fa fa-file"></i> Инструменты страницы      </li>
      <li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=edit"  class="action source" accesskey="v" rel="nofollow" title="Показать исходный текст [V]"><i class="fa fa-pencil-square-o"></i> Показать исходный текст</a></li><li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=revisions"  class="action revs" accesskey="o" rel="nofollow" title="История страницы [O]"><i class="fa fa-clock-o"></i> История страницы</a></li><li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=backlink"  class="action backlink" rel="nofollow" title="Ссылки сюда"><i class="fa fa-link"></i> Ссылки сюда</a></li><li><a href="/wiki/doku.php/abills:docs_03:install:ru?do=export_pdf"  class="action export_pdf" rel="nofollow" title="Экспорт в PDF"><span>Экспорт в PDF</span></a></li><li>    <a href=/wiki/doku.php/abills:docs_03:install:ru?do=addtobook  class="action addtobook" rel="nofollow" title="Добавить в книгу">        <span>Добавить в книгу</span>    </a></li><li><a href="#dokuwiki__top"  class="action top" accesskey="t" rel="nofollow" title="Наверх [T]"><i class="fa fa-chevron-up"></i> Наверх</a></li>
...
<li class="level2"> <a href="/wiki/doku.php/abills:docs:features:ru" class="wikilink1" title="abills:docs:features:ru">Возможности</a>
</li>
<li class="level2"> <a href="/wiki/doku.php/abills:demo:demo" class="wikilink1" title="abills:demo:demo"> Demo </a>
</li>
</ul>
</li>
</ul>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:manual:install_ubuntu:ru" class="wikilink1" title="abills:docs:manual:install_ubuntu:ru">Ubuntu</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:manual:install_debian:ru" class="wikilink1" title="abills:docs:manual:install_debian:ru">Debian</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:manual:install_centos:ru" class="wikilink1" title="abills:docs:manual:install_centos:ru">CentOS</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:bonus:ru" class="wikilink1" title="abills:docs:modules:bonus:ru">Bonus</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:bsr1000:ru" class="wikilink1" title="abills:docs:bsr1000:ru">BSR1000</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:cards:ru" class="wikilink1" title="abills:docs:modules:cards:ru">Cards</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:dv:ru" class="wikilink1" title="abills:docs:modules:dv:ru">Dv</a> (Internet)
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:dhcphosts:ru" class="wikilink1" title="abills:docs:modules:dhcphosts:ru">Dhcphosts</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:docs:ru" class="wikilink1" title="abills:docs:docs:ru">Docs</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:dunes:ru" class="wikilink1" title="abills:docs:dunes:ru">Dunes</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:equipment:ru" class="wikilink1" title="abills:docs:modules:equipment:ru">Equipment</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:extfin:ru" class="wikilink1" title="abills:docs:modules:extfin:ru">Extfin</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:ipn:ru" class="wikilink1" title="abills:docs:modules:ipn:ru">Ipn</a> (IPoE)
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:iptv:ru" class="wikilink1" title="abills:docs:modules:iptv:ru">Iptv</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:vlan:ru" class="wikilink1" title="abills:docs:modules:vlan:ru">Vlan</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:mail:ru" class="wikilink1" title="abills:docs:modules:mail:ru">Mail</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:managers:ru:abills" class="wikilink1" title="abills:docs:modules:managers:ru:abills">Managers</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:maps:ru" class="wikilink1" title="abills:docs:modules:maps:ru">Maps</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:paysys:ru" class="wikilink1" title="abills:docs:modules:paysys:ru">Paysys</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:voip:ru" class="wikilink1" title="abills:docs:voip:ru">Voip</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:sharing:ru" class="wikilink1" title="abills:docs:modules:sharing:ru">Sharing</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:snmputils:ru" class="wikilink1" title="abills:docs:modules:snmputils:ru">Snmputils</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:sms:ru" class="wikilink1" title="abills:docs:modules:sms:ru">Sms</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:modules:storage:ru" class="wikilink1" title="abills:docs:modules:storage:ru">Storage</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:sqlcmd:ru" class="wikilink1" title="abills:docs:sqlcmd:ru">Sqlcmd</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:squid:ru" class="wikilink1" title="abills:docs:squid:ru">Squid</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:mpd:ru" class="wikilink1" title="abills:docs:mpd:ru">MPD</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:portmaste:ru" class="wikilink1" title="abills:docs:nas:portmaste:ru">Livingston Portmaster 2/3</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:radpppd:en" class="wikilink1" title="abills:docs:nas:radpppd:en">radpppd</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:chillispot:ru" class="wikilink1" title="abills:docs:nas:chillispot:ru">Сhillispot</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:cisco_2511:ru" class="wikilink1" title="abills:docs:nas:cisco_2511:ru">Сisco</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:cisco_isg:ru" class="wikilink1" title="abills:docs:nas:cisco_isg:ru">Cisco ISG</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:gnugk:ru" class="wikilink1" title="abills:docs:nas:gnugk:ru">GNUgk</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:hotspot:ru" class="wikilink1" title="abills:docs:nas:hotspot:ru">Hotspot</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:mikrotik:ru" class="wikilink1" title="abills:docs:nas:mikrotik:ru">Mikrotik</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:3com_5232:ru" class="wikilink1" title="abills:docs:nas:3com_5232:ru">3Com 5232</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:lepppd:ru" class="wikilink1" title="abills:docs:nas:linux:lepppd:ru">Linux PPPD IPv4 zone counters</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:pppd_radattr:ru" class="wikilink1" title="abills:docs:nas:linux:pppd_radattr:ru">Linux PPPD + radattr.so</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:accel_pptp:ru" class="wikilink1" title="abills:docs:nas:linux:accel_pptp:ru">Linux accel-ppp</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:accel_ipoe:ru" class="wikilink1" title="abills:docs:nas:linux:accel_ipoe:ru">Linux accel-ipoe</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:radcoad:ru" class="wikilink1" title="abills:docs:nas:linux:radcoad:ru">Linux PPPD + radcoad</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:linux:linux_isg:ru" class="wikilink1" title="abills:docs:nas:linux:linux_isg:ru">Linux ISG</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:vyatta:vyatta:ru" class="wikilink1" title="abills:docs:nas:vyatta:vyatta:ru">Vyatta</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:lucent_max_tnt:ru" class="wikilink1" title="abills:docs:nas:lucent_max_tnt:ru">Lucent MAX TNT</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:usr_netserver:ru" class="wikilink1" title="abills:docs:nas:usr_netserver:ru">USR Netserver 8/16</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:patton:ru" class="wikilink1" title="abills:docs:nas:patton:ru">Patton</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:openvpn:ru:openvpn" class="wikilink1" title="abills:docs:nas:openvpn:ru:openvpn">OpenVPN</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:juniper:ru:juniper" class="wikilink1" title="abills:docs:nas:juniper:ru:juniper">Juniper</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:nas:ericsson_smartedge:ru:ericsson_smartedge" class="wikilink1" title="abills:docs:nas:ericsson_smartedge:ru:ericsson_smartedge">Ericsson SmartEdge</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:rlm_perl:ru" class="wikilink1" title="abills:docs:rlm_perl:ru">rlm_perl</a>
</li>
...
<li class="level4"> <a href="/wiki/doku.php/abills:docs:mrtg:ru" class="wikilink1" title="abills:docs:mrtg:ru">MRTG</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:graphics.cgi:ru:abills" class="wikilink1" title="abills:docs:graphics.cgi:ru:abills">graphics.cgi</a>
</li>
<li class="level4"> <a href="/wiki/doku.php/abills:docs:callcenter:atrey:ru" class="wikilink1" title="abills:docs:callcenter:atrey:ru"> ATrey </a>
</li>
...
<li class="level3"> <a href="/wiki/doku.php/abills:changelogs:0.5x" class="wikilink1" title="abills:changelogs:0.5x">0.5x</a>
</li>
<li class="level3"> <a href="/wiki/doku.php/abills:changelogs:0.4x" class="wikilink1" title="abills:changelogs:0.4x">Old</a>
</li>
</ul>
</div></div></div>
<p>
...
<ul class="nav nav-pills nav-stacked">
<li class="level1"> <a href="/wiki/doku.php/abills:docs:download:download" class="wikilink1" title="abills:docs:download:download">Скачать</a>
</li>
<li class="level1"> <a href="/wiki/doku.php/abills:price:price" class="wikilink1" title="abills:price:price"> Цены</a>
</li>
...
<li class="level1"> <a href="/wiki/doku.php/abills:contact:contact" class="wikilink1" title="abills:contact:contact">Contact</a>
</li>
<li class="level1"> <strong><a href="http://abills.net.ua/wiki/doku.php/abills?do=recent" class="urlextern" title="http://abills.net.ua/wiki/doku.php/abills?do=recent"  rel="nofollow"> Последние изменения</a></strong>
</li>
</ul>
...
Вы перешли по ссылке на тему, для которой ещё не создана страница. Если позволяют ваши права доступа, вы можете создать её, нажав на кнопку «Создать страницу».
      ...
      <footer id="dokuwiki__footer" class="small">
        ...
        <a href="javascript:void(0)" class="back-to-top hidden-print btn btn-default btn-sm" title="Перейти к содержанию" id="back-to-top"><i class="fa fa-chevron-up"></i></a>
