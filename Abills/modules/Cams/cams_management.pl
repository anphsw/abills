...
BEGIN {
  use FindBin qw/$Bin/;
  $abills_dir = $Bin . "/../"; # Assuming we are in /usr/abills/libexec/ or /usr/abills/misc/
}
use lib $abills_dir;
use lib "$abills_dir/lib";
use lib "$abills_dir/Abills/mysql";

use Abills::Defs;
use Abills::Base qw/parse_arguments _bp cmd/;
use Abills::SQL;
