        ...
        <div class='row'>
            <div class='col-md-6'>
                <div class='box box-theme box-big-form'>
                    <div class='box-header with-border'><h4 class='box-title'>_{TARIF_PLAN}_ #%ID%</h4></div>
                    <div class='box-body'>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-9'>
                                <input type='text' class='form-control' required name='STREAMS_COUNT'
                                       value='%STREAMS_COUNT%'
                                       id='STREAMS_COUNT_id'/>
                            </div>
                        </div>
                ...
                <div class='box collapsed-box box-theme box-big-form'>
                    ...
                    <div class='box-body'>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-9'>
                                <input id='PERIOD_ALIGNMENT' name='PERIOD_ALIGNMENT' value='1'
                                       %PERIOD_ALIGNMENT%
                                       type='checkbox'>
                            </div>
                        </div>
