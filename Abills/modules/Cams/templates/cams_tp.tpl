      ...
      <div class='card card-primary card-outline card-big-form'>
        ...
        <div class='card-body'>
          ...
          <div class="form-group custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="PERIOD_ALIGNMENT" name="PERIOD_ALIGNMENT"
                   %PERIOD_ALIGNMENT% value='1' data-input-disables='ABON_DISTRIBUTION'>
            <label for="PERIOD_ALIGNMENT" class="custom-control-label">_{MONTH_ALIGNMENT}_</label>
          </div>
      ...
      <div class='card collapsed-card card-primary card-outline box-big-form'>
        ...
        <div class='card-body'>
          ...
          <div class='form-group row'>
            <div class='col-md-6'>
              <div class="form-group custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="DVR" name="DVR" %DVR% value='1'>
                <label for="DVR" class="custom-control-label">DVR</label>
              </div>
            </div>
            <div class='col-md-6'>
              <div class="form-group custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="PTZ" name="PTZ" %PTZ% value='1'>
                <label for="PTZ" class="custom-control-label">PTZ</label>
              </div>
            </div>
          </div>
