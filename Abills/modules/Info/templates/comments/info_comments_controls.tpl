...
<button role='button' class='btn btn-default btn-xs btn-success' id='info_comments_refresh'
        ...
        data-renews="#commentsBlock"  data-source="info_renew_comments">
        ...
        <form class='form-horizontal form-horizontal' id='form_add_comments'>
            <div class='modal-content'>
                <div class='modal-header'>
                    ...
                    <h4 class='modal-title' id='info_comments_modal_title'>$lang{ADD} $lang{COMMENTS}</h4>
                </div>
                <div class='modal-body' id='info_comments_body'>
                    <div class='row'>
                        ...
                        <div class='form-group'>
                            <label class='control-label col-md-3' for='COMMENTS_TEXT'>$lang{COMMENTS}</label>
                ...
                <div class='modal-footer'>
                    ...
                    <button type='submit' class='btn btn-primary' id='go'>$lang{ADD}</button>
                </div>
            </div><!-- /.modal-content -->
    </form>
</div><!-- /.modal-dialog -->
