$langMEGOGO = 'MEGOGO. Кіно і ТБ';
$langADD_TP = 'Додати';
$langUSER_LIST = 'Показати користувачів';
$lang{TPS} = 'Підписки';
...
$lang{WARNING} = 'Для перегляду купленої підписки зареєструйтесь або авторизуйтесь на Megogo.net, натиснувши кнопку нижче:';
