      ...
      <div class='card card-primary card-outline'>
        ...
        <div class='card-body'>
          ...
          <div class='form-group row'>
            <label class='control-label col-md-2' for='ROWS'>_{ROWS}_:</label>
            <div class='col-md-2'><input type=text class='form-control' id='ROWS' name='ROWS' value='%ROWS%'></div>
          ...
          <div class='form-group row'>
            ...
            <div class='col-md-6'><input type=text name='COMMENTS' value='%COMMENTS%' id='COMMENTS' class='form-control'></div>
          </div>
