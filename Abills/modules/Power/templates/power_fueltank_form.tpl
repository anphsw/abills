<form action='%SELF_URL%' method='POST' class='form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form'>
    <div class='card-header'>
      <h4 class='card-title'>_{POWER_TANK_TYPE}_</h4>
    </div>
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right required' for='LITRES'>_{POWER_CAPACITY_IN_LITERS}_:</label>
        <div class='col-md-8'>
          <input class='form-control' type='number' name='LITRES' required id='LITRES' value='%LITRES%' min='0'>
        </div>
      </div>
