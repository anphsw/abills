<div class='panel panel-primary panel-form'>
    <div class='panel-heading text-center'><h4>_{PRIORITY}_</h4></div>
    ...
    <div class='panel-footer text-center'>
        <input type='submit' form='form_EVENTS_PRIORITY_FORM' class='btn btn-primary' name='%SUBMIT_BTN_ACTION%'
