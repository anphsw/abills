...
<div class='card card-primary card-outline'>
    ...
    <div class='card-body container-fluid'>
        ...
        <div class="row">
            ...
            <div class="offset-lg-2 col-lg-5" id="import-field-to">
                %OUTPUT_STRUCTURE%
            </div>
        </div>
...
<div class="modal fade" id="import-progress-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="progress">
                    <div class="progress-bar" id="import-progress-modal-progressbar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="0"></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="import-progress-modal-close" class="btn btn-primary hidden" data-dismiss="modal">_{CLOSE}_</button>
            </div>
        </div>
    </div>
</div>
...
<template id="import-field-template">
    <div
        draggable="true"
        class="card card-outline import-field"
    >
        <div class='card-header'>
            <span class="import-field-name"></span>
            <a data-tooltip="Cписания" data-tooltip-position="top" data-content="Cписания" data-html="true" data-toggle="popover" data-trigger="hover" data-placement="top" data-container="body" data-original-title="" title="">
            <i
                class="pull-right import-field-examples fa fa-info"></i>
            </a>
        </div>
    </div>
</template>
...
<script>
    ...
    class CablecatImportLoader {
        ...
        useFilter(element) {
            return this
                .filter
                .every(({ field, condition}) => element[field] && element[field] == condition)
        }
