  ...
  my @output_fields = (
    {
      NAME       => $lang{NAME},
      FIELD_NAME => 'NAME',
      INPUT      => $html->form_input('', '', { EX_PARAMS => "class='pull-right' placeholder='$lang{NAME} $lang{DEFAULT}'", OUTPUT2RETURN => 1 })
    },
    {
      NAME       => $lang{TYPE},
      FIELD_NAME => 'TYPE_ID',
    ...
    },
    {
      ...
      INPUT      => $html->form_input('', '', { TYPE => 'checkbox',  EX_PARAMS => "class='pull-right'", OUTPUT2RETURN => 1 })
    },
    {
      NAME       => 'COORDX',
      FIELD_NAME => 'COORDX',
