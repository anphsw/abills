<form action='%SELF_URL%' method='GET' class='form-horizontal'>
  ...
  <div class='card container-md card-primary card-outline'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{IDENT1}_:</label>
        <div class='col-md-9'>
          <input class='form-control' type='text' name='IDENT1' value='%IDENT1%'>
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{IDENT2}_:</label>
        <div class='col-md-9'>
          <input class='form-control' type='text' name='IDENT2' value='%IDENT2%'>
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{IDENT3}_:</label>
        <div class='col-md-9'>
          <input class='form-control' type='text' name='IDENT3' value='%IDENT3%'>
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{IDENT4}_:</label>
        <div class='col-md-9'>
