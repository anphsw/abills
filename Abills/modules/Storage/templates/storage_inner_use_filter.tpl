<form action='%SELF_URL%' method='GET' class='form-horizontal'>
  ...
  <div class='card container-md card-primary card-outline'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{STORAGE_IDENT}_1:</label>
        <div class='col-md-9'>
          <input class='form-control' type='text' name='IDENT1' value='%IDENT1%'>
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{STORAGE_IDENT}_2:</label>
        <div class='col-md-9'>
          <input class='form-control' type='text' name='IDENT2' value='%IDENT2%'>
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-form-label text-md-right col-md-3'>_{STORAGE_IDENT}_3:</label>
        <div class='col-md-9'>
