    ...
    <div class='card card-primary card-outline'>
      ...
      <div class='card-body'>
        ...
        <div class='col-md-12 row'>
          <div class='col-md-6' data-visible='%PUSH_RADIO_VISIBLE%'>
            <label>
              <input type='radio' name='SEND_TYPE' id='SEND_TYPE_PUSH' value='Push' checked='checked'>
              <strong>Push</strong>
            </label>
          </div>
          <div class='col-md-6' data-visible='%BROWSER_RADIO_VISIBLE%'>
            <label>
        ...
        <div class='form-group row'>
          <label for='MESSAGE' class='col-md-12 control-label'>_{MESSAGE}_:</label>
          <div class='col-md-12'>
