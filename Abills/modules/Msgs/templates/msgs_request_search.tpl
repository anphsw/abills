    ...
    <div class='card card-primary card-outline container-md'>
        <div class='card-header with-border'>
            <h3 class='card-title'>_{REQUESTS}_</h3>
        ...
        <div class='card-body'>
            ...
            <div class='form-group row'>
                ...
                <div class='col-md-9'>
                    <input id='NUMBER' name='ID' value='%REQUESTS_ID_FORM%' placeholder='%REQUESTS_ID_FORM%'
            ...
            <div class='form-group row'>
                ...
                <div class='col-md-9'>
                    <input id='CONNECTION_TIME' name='CONNECTION_TIME' value='%CONNECTION_TIME%'
                           placeholder='%CONNECTION_TIME%' class='form-control' type='text'>
                </div>
            </div>
            ...
            <div class='form-group row' align='left'>
                <label class='control-label col-md-3' for='CLOSE_FROM_DATE'>_{CLOSED}_ _{PERIOD}_:</label>
                <div class=' col-md-4'>
                    %CLOSE_FROM_DATE%
                </div>
