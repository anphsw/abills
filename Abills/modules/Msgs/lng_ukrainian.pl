...
$lang{EVERYTHING_EXCEPT_CLOSED} = 'Всі окрім закритих';
...
$lang{MSGS_NO_MATCHES_FOUND} = 'Співпадінь не знайдено';
$lang{MSGS_MATCHES_FOUND} = 'Співпадіння знайдено';
$lang{MSGS_RESPONSIBLE_PERSON} = 'Відповідальна особа';
$lang{MSGS_RESPONSIBLE_PERSON_CLIENT_SIDE} = 'Відповідальна особа з боку клієнта';
...
$lang{MSGS_RELATED_MESSAGES} = 'Пов\'язані повідомлення';
$lang{MSGS_NO_UNPLANNED_MESSAGES} = 'Немає незапланованих повідомлень';
$lang{MSGS_LOADED_MESSAGES} = 'Завантажено повідомлень';
$lang{MSGS_FILTER_BY_ADMIN} = 'Фільтр за адміністратором';
$lang{MSGS_ALL_ADMINS} = 'Всі адміністратори';
$lang{MSGS_UNPLANNED_MESSAGES} = 'Незаплановані повідомлення';
$lang{MSGS_LOAD_MORE} = 'Завантажити більше';
$lang{MSGS_EXTERNAL_CHATS} = 'Зовнішні чати';
$lang{MSGS_EXTERNAL_CHAT} = 'Зовнішній чат';
$lang{MSGS_USER_LINKED} = 'Користувача прив\'язано';
$lang{MSGS_MESSAGE_ADDED} = 'Повідомлення додано';
$lang{MSGS_CHAT_ID} = 'ID чата';
$lang{MSGS_STATUS_CHANGE_HISTORY} = 'Історія статусів';
$lang{MSGS_AI_ANSWER_WILL_APPEAR_HERE} = 'Тут з’явиться відповідь ШІ...';
$lang{MSGS_TICKET_ID_NOT_FOUND} = 'Не знайдено ID тікета';
$lang{MSGS_GENERATION_LANGUAGE} = 'Мова генерації';
$lang{MSGS_AUTO} = 'Авто';
$lang{MSGS_TRANSLATE} = 'Перекласти';
$lang{MSGS_GENERATING} = 'Генерую…';
$lang{MSGS_GENERATING_RESPONSE} = 'Генерую відповідь…';
$lang{MSGS_RESPONSE_GENERATED} = 'Відповідь згенеровано';
$lang{MSGS_GENERATION_ERROR} = 'Помилка генерації';
$lang{MSGS_NO_TEXT_TO_TRANSLATE} = 'Немає тексту для перекладу';
$lang{MSGS_TRANSLATING} = 'Перекладаю…';
$lang{MSGS_TRANSLATED} = 'Перекладено';
$lang{MSGS_TRANSLATION_ERROR} = 'Помилка перекладу';
$lang{MSGS_INSERT_TO_REPLY} = 'Вставити у відповідь';
$lang{MSGS_ASK_FOLLOWUP} = 'Уточнити запит';
$lang{MSGS_SEND_TO_CLIENT} = 'Надіслати абоненту';
$lang{MSGS_AI_FOLLOWUP_PLACEHOLDER} = 'Уточнення або додаткове питання...';
$lang{MSGS_ENTER_QUESTION} = 'Введіть питання';
$lang{MSGS_ASK} = 'Запитати';
$lang{MSGS_AI_WAS_HELPFUL} = 'Відповідь була корисною?';
$lang{MSGS_AI_USEFUL} = 'Корисна';
$lang{MSGS_AI_NOT_USEFUL} = 'Не корисна';
$lang{MSGS_AI_FEEDBACK_SAVED} = 'Дякуємо за оцінку';
$lang{MSGS_AI_FEEDBACK_ERROR} = 'Помилка збереження оцінки';
$lang{MSGS_MESSAGES} = 'Повідомлення';
