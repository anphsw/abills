...
$lang{BRIGADES} = 'Бригады';
$lang{MEMBERS} = 'Участники';
$lang{ASSIGNED_BRIGADE} = 'Назначенная бригада';
$lang{WORK_REGION} = 'Рабочий регион';
...
$lang{MSGS_SUPPORT_REQUEST_HEADER} = 'Отправлен запрос на поддержку';
...
$lang{MSGS_BOLD} = 'Жирный';
$lang{MSGS_SPOILER} = 'Спойлер';
$lang{MSGS_NUMBER_OF_ANSWERS} = 'Количество ответов';
$lang{MSGS_ANSWERS} = 'Ответы';
$lang{MSGS_NUMBER_OF_USES} = 'Количество использований';
$lang{MSGS_NO_MATCHES_FOUND} = 'Совпадений не найдено';
$lang{MSGS_MATCHES_FOUND} = 'Совпадения найдены';
$lang{MSGS_RESPONSIBLE_PERSON} = 'Ответственное лицо';
$lang{MSGS_RESPONSIBLE_PERSON_CLIENT_SIDE} = 'Ответственное лицо со стороны клиента';
...
$lang{ERR_MESSAGE_SECONDS_LIMIT} = 'Сообщения можно отправлять не чаще, чем раз в %LIMIT% секунд';
$lang{ERR_NO_ATTACHMENT} = 'Вложение с идентификатором %ID% не найдено';
$lang{ERR_READ_ATTACHMENT} = 'Вложение с идентификатором %ID% не найдено';
$lang{ERR_NO_PERMISSION_ADD_MESSAGE} = 'Нет разрешения на добавление сообщений';
$lang{ERR_NO_PERMISSION_TO_CHAPTER} = 'Нет разрешения на доступ к этому разделу';
$lang{ERR_NO_MESSAGE_ACCESS} = 'Сообщение недоступно';
$lang{ERR_NO_ATTACHMENT_ADDED} = 'Вложения не добавлены';
...
$lang{MSGS_RELATED_MESSAGES} = 'Связанные сообщения';
$lang{MSGS_NO_UNPLANNED_MESSAGES} = 'Нет незапланированных сообщений';
$lang{MSGS_LOADED_MESSAGES} = 'Загружено сообщений';
$lang{MSGS_FILTER_BY_ADMIN} = 'Фильтр по администратору';
...
$lang{MSGS_STATUS_CHANGE_HISTORY} = 'История статусов';
$lang{MSGS_AI_ANSWER_WILL_APPEAR_HERE} = 'Здесь появится ответ ИИ...';
$lang{MSGS_TICKET_ID_NOT_FOUND} = 'ID тикета не найден';
$lang{MSGS_GENERATION_LANGUAGE} = 'Язык генерации';
$lang{MSGS_AUTO} = 'Авто';
$lang{MSGS_TRANSLATE} = 'Перевести';
$lang{MSGS_GENERATING} = 'Генерирую…';
$lang{MSGS_GENERATING_RESPONSE} = 'Генерирую ответ…';
$lang{MSGS_RESPONSE_GENERATED} = 'Ответ сгенерирован';
$lang{MSGS_GENERATION_ERROR} = 'Ошибка генерации';
$lang{MSGS_NO_TEXT_TO_TRANSLATE} = 'Нет текста для перевода';
$lang{MSGS_TRANSLATING} = 'Перевожу…';
$lang{MSGS_TRANSLATED} = 'Переведено';
$lang{MSGS_TRANSLATION_ERROR} = 'Ошибка перевода';
$lang{MSGS_INSERT_TO_REPLY} = 'Вставить в ответ';
$lang{MSGS_ASK_FOLLOWUP} = 'Уточнить запрос';
$lang{MSGS_SEND_TO_CLIENT} = 'Отправить абоненту';
$lang{MSGS_AI_FOLLOWUP_PLACEHOLDER} = 'Уточнение или дополнительный вопрос...';
$lang{MSGS_ENTER_QUESTION} = 'Введите вопрос';
$lang{MSGS_ASK} = 'Спросить';
$lang{MSGS_AI_WAS_HELPFUL} = 'Ответ был полезным?';
$lang{MSGS_AI_USEFUL} = 'Полезный';
$lang{MSGS_AI_NOT_USEFUL} = 'Не полезный';
$lang{MSGS_AI_FEEDBACK_SAVED} = 'Спасибо за оценку';
$lang{MSGS_AI_FEEDBACK_ERROR} = 'Ошибка сохранения оценки';
$lang{MSGS_MESSAGES} = 'Сообщения';
