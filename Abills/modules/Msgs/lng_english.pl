...
$lang{MSGS_STATUS_CHANGE_HISTORY} = 'Status change history';
$lang{MSGS_AI_ANSWER_WILL_APPEAR_HERE} = 'The AI answer will appear here...';
$lang{MSGS_TICKET_ID_NOT_FOUND} = 'Ticket ID not found';
$lang{MSGS_GENERATION_LANGUAGE} = 'Generation language';
$lang{MSGS_AUTO} = 'Auto';
$lang{MSGS_TRANSLATE} = 'Translate';
$lang{MSGS_GENERATING} = 'Generating…';
$lang{MSGS_GENERATING_RESPONSE} = 'Generating response…';
$lang{MSGS_RESPONSE_GENERATED} = 'Response generated';
$lang{MSGS_GENERATION_ERROR} = 'Generation error';
$lang{MSGS_NO_TEXT_TO_TRANSLATE} = 'No text to translate';
$lang{MSGS_TRANSLATING} = 'Translating…';
$lang{MSGS_TRANSLATED} = 'Translated';
$lang{MSGS_TRANSLATION_ERROR} = 'Translation error';
$lang{MSGS_INSERT_TO_REPLY} = 'Insert to reply';
$lang{MSGS_ASK_FOLLOWUP} = 'Ask follow-up';
$lang{MSGS_SEND_TO_CLIENT} = 'Send to client';
$lang{MSGS_AI_FOLLOWUP_PLACEHOLDER} = 'Follow-up question or clarification...';
$lang{MSGS_ENTER_QUESTION} = 'Enter a question';
$lang{MSGS_ASK} = 'Ask';
$lang{MSGS_AI_WAS_HELPFUL} = 'Was this response helpful?';
$lang{MSGS_AI_USEFUL} = 'Helpful';
$lang{MSGS_AI_NOT_USEFUL} = 'Not helpful';
$lang{MSGS_AI_FEEDBACK_SAVED} = 'Thanks for your feedback';
$lang{MSGS_AI_FEEDBACK_ERROR} = 'Failed to save feedback';
$lang{MSGS_MESSAGES} = 'Messages';
