...
$lang{STALKER_MIDDLEWARE_ADD_CHANNEL}='Добавлення канала - Stalker Middleware';
$lang{NAME_STALKER_FORM}='Имя';
$lang{TEMPORARY_HTTP_LINK}='Тимчасова HTTP ссилка';
...
$lang{TV_NEWS_ARCHIVE}='Вести ТБ архив';
$lang{NEWS_MONITORING}='Вести моніторинг';
$lang{URL_CHANNEL_FOR_MONITORING}='URL канала для моніторинга';
...
$lang{FIELD_ARE_REQUIRED}='Поля обовязкові для заповнення: ';
$lang{ONLY} = 'тільки';
$lang{THIS_NUMBER_ALREADY_EXISTS}='Такий номер уже існує';
$lang{EXPORT_TARIFFS} = 'Экспорт тарифних планів';
$lang{EXTERNAL_ID} ='Зовнішній ID';
$lang{NEED_CONFIRM}='Включитичи підтверждення отримання';
