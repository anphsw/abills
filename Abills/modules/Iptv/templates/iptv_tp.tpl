    ...
    <div class='container-fluid'>
        <div class='row'>
            <div class='col-md-6'>
                <div class='panel panel-primary'>
                    <div class='panel-heading'>
                        <a data-toggle='collapse' data-parent='#accordion' href='#_tp' style='color: #FFFFFF;'>_{TARIF_PLAN}_</a>
                    </div>
                    <div id='_tp' class='panel-body panel-collapse collapse in'>
            ...
            <div class='col-md-6'>
                <div class='panel panel-primary'>
                    <div class='panel-heading'>
                        <a data-toggle='collapse' data-parent='#accordion' href='#_abon' style='color: #FFFFFF;'>_{ABON}_</a>
                    </div>

                    <div id='_abon' class='panel-body panel-collapse collapse out'>
        ...
        <div class='row'>
            <div class='col-md-6'>
                <div class='panel panel-primary'>
                    <div class='panel-heading'>
                        <a data-toggle='collapse' data-parent='#accordion' href='#_other' style='color: #FFFFFF;'>_{OTHER}_</a>
                    </div>
                    ...
                    <div id='_other' class='panel-body panel-collapse collapse out'>
                        ...
                        <div class='form-group'>
                            <label for='NEXT_TARIF_PLAN_SEL' class='control-label col-md-3'>_{NEXT_PERIOD_TP}_:</label>
                            <div class='col-md-9'>
                                %NEXT_TARIF_PLAN_SEL%
                            </div>
                        </div>
