...
sub user_add {
  ...
  Abills::Base::_bp('Add', $attr->{STATUS}, {HEADER=>1});
  # Abills::Base::_bp('Add', $attr, {HEADER=>1});
}
...
sub user_change {
  ...
  Abills::Base::_bp('Change', $attr->{STATUS}, {TO_CONSOLE=>1});
  Abills::Base::_bp('Change', $attr->{FILTER_ID}, {TO_CONSOLE=>1});
  Abills::Base::_bp('Change', $attr->{TP_FILTER_ID}, {TO_CONSOLE=>1});
...
sub user_negdeposit {
  ...
  Abills::Base::_bp('', "Negdeposit: " . ($attr->{STATUS} || ''), {TO_CONSOLE=>1});
...
sub hangup {
  ...
  Abills::Base::_bp('', 'Hangup', {HEADER=>1});
...
sub channels_change {
  my $self = shift;
  my ($attr) = @_;
  # Abills::Base::_bp('', "change_channels ", {HEADER=>1});
  # Abills::Base::_bp('', $attr->{ADD_ID}, {HEADER=>1});
  # #
  $self->{errno} = '10100';
