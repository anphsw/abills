...
<FORM action='$SELF_URL' METHOD='POST' ID='REGISTRATION'>
  ...
  <div class='card center-block container-md'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-sm-4 col-md-4' for='PHONE_PATTERN_FIELD'>_{PHONE}_:</label>
        <div class='col-sm-8 col-md-8'>
      ...
      <div class='form-group row'>
        ...
        <div class='col-sm-8 col-md-8'>
          <div class='input-group'>
            <input id='EMAIL' name='EMAIL' value='%EMAIL%' placeholder='E-mail' required class='form-control'
                   type='text'>
          </div>
        </div>
      </div>
      ...
      <div class='form-group row %HIDE_TP%'>
        <label class='col-sm-4 col-md-4'>_{TARIF_PLAN}_:</label>
        <div class='col-sm-8 col-md-8'>
          <div class='input-group'>
            %TP_SEL%
          </div>
