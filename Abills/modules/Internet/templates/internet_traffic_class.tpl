            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <label class='control-label col-md-10 required' for='NAME_id'>_{NAME}_</label>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <label class='control-label col-md-10' for='COMMENTS_id'>_{COMMENTS}_</label>
                        <div class="input-group">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <label class='col-md-12 required' for='NETS_id'>NETS (192.168.101.0/24;10.0.0.0/28)</label>
                        <div class="input-group">
