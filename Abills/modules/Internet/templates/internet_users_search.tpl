  ...
  <div class="card card-primary card-outline box-big-form">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">%NAS_SEL%</div>
      </div>
    ...
    <div class="card-body">
          ...
          <div class="input-group">
            ...
            <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_:">
              ...
              <input
                type="checkbox"
                name="PERSONAL_TP"
                data-input-disables="PERSONAL_TP"
                value="!"
                />
            </span>
          </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <div class="input-group">
            <input
              id="INTERNET_ACTIVATE"
              name="INTERNET_ACTIVATE"
              value="%INTERNET_ACTIVATE%"
              placeholder="%INTERNET_ACTIVATE%"
            ...
            <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
              ...
              <input
                type="checkbox"
                name="INTERNET_ACTIVATE"
                data-input-disables="INTERNET_ACTIVATE"
                value="!"
                />
            </span>
          </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <div class="input-group">
            <input
              id="INTERNET_EXPIRE"
              name="INTERNET_EXPIRE"
              value="%INTERNET_EXPIRE%"
              placeholder="%INTERNET_EXPIRE%"
              class="form-control datepicker"
              type="text"
              />
            <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
              ...
              <input
                type="checkbox"
                name="INTERNET_EXPIRE"
                data-input-disables="INTERNET_EXPIRE"
                value="!"
                />
            </span>
          </div>
        ...
        <div class="col-md-9">
          <div class="input-group">
            <input
              id="SIMULTANEONSLY"
              name="SIMULTANEONSLY"
              value="%SIMULTANEONSLY%"
              placeholder="%SIMULTANEONSLY%"
              class="form-control"
              type="text"
              />
            <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
              ...
              <input
                type="checkbox"
                name="SIMULTANEONSLY"
                data-input-disables="SIMULTANEONSLY"
                value="!"
                />
            </span>
          </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <input
            ...
            name="INTERNET_REGISTRATION"
            value="%INTERNET_REGISTRATION%"
            class="form-control datepicker"
            type="text"
            />
        </div>
