    ...
    <div class='box box-theme box-big-form'>
        ...
        <div class='box-body'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <div class="input-group">
                        <input id='CPE_MAC' name='CPE_MAC' value='%CPE_MAC%' placeholder='%CPE_MAC%'
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <div class="input-group">
                        <input id='PORT' name='PORT' value='%PORT%' placeholder='%PORT%' class='form-control'
                               type='text'>
                        <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
                      <i class='fa fa-exclamation'></i>
...
<div class='сol-xs-12 col-md-6'>
    <div class='box collapsed-box box-theme box-big-form'>
        ...
        <div class='box-body'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <div class="input-group">
                        ...
                        <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
                              <i class='fa fa-exclamation'></i>
                              <input type="checkbox" name='INTERNET_ACTIVATE' data-input-disables=INTERNET_ACTIVATE
                                     value='!'>
                            </span>
                    </div>
                </div>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <div class="input-group">
                        ...
                        <span class="input-group-addon" data-tooltip="_{EMPTY_FIELD}_">
                              <i class='fa fa-exclamation'></i>
                              <input type="checkbox" name='INTERNET_EXPIRE' data-input-disables=INTERNET_EXPIRE
                                     value='!'>
                            </span>
                    </div>
                </div>
            ...
            <div class='form-group'>
                <label class='col-md-3 control-label' for='INTERNET_REGISTRATION'>Internet _{DATE}_
                    _{REGISTRATION}_</label>
                <div class='col-md-9'>
