<div class='card card-primary card-outline %PARAMS% collapsed-card' form='internet_users_list'>
    ...
    <div class='card-body'>
        ...
        <div class='form-group'>
            <div class='row'>
                <div class='col-md-4'>
                    ...
                    <label class='col-form-label text-md-left form-check-label'
                           for='MU_REDUCTION'>_{REDUCTION}_(%)</label>
                </div>
        ...
        <div class='form-group' %IPV6_HIDE%>
            <div class='row'>
                <div class='col-md-4'>
                    ...
                    <label class='col-form-label text-md-left form-check-label' for='MU_SET_IPV6'>_{SET}_ _{STATIC}_
                        IPv6</label>
                </div>
                <div class='col-md-8'>
                    %MU_IPV6_POLL_SEL%
        ...
        <div class='form-group'>
            <div class='row'>
                <div class='col-md-4'>
                    ...
                    <label class='col-form-label text-md-left form-check-label' for='MU_SET_IPV4'>_{SET}_ _{STATIC}_
                        IPv4</label>
                </div>
                <div class='col-md-8'>
                    %MU_IPV4_POLL_SEL%
        ...
        <div class='form-group d-none %MU_USER_TAGS_VISIBLE%'>
            <div class='row'>
                <div class='col-md-4'>
                    ...
                    <label class='col-form-label text-md-left form-check-label' for='MU_TAGS_USER'>_{TAGS}_
                        _{USER}_</label>
                </div>
                <div class='col-md-8'>
                    %MU_USER_TAGS%
        ...
        <div class='form-group'>
            <div class='row'>
                <div class='col-md-4'>
                    <input type='checkbox' name='MU_SERVICE_ACTIVATE' value='1' form='internet_users_list'
                           id='MU_SERVICE_ACTIVATE'>
                    <label class='col-form-label text-md-left form-check-label' for='MU_SERVICE_ACTIVATE'>_{INTERNET}_:
                        _{ACTIVATE}_</label>
                </div>
                <div class='col-md-8'>
        ...
        <div class='form-group'>
            <div class='row'>
                <div class='col-md-4'>
                    <input type='checkbox' name='MU_SERVICE_EXPIRE' value='1' form='internet_users_list'
                           id='MU_SERVICE_EXPIRE'>
                    <label class='col-form-label text-md-left form-check-label' for='MU_SERVICE_EXPIRE'>_{INTERNET}_:
                        _{EXPIRE}_</label>
                </div>
                <div class='col-md-8'>
