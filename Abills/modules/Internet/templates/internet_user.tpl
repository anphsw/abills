  ...
  <div class='box box-theme box-big-form'>
    <div class='box-header with-border'>
      ...
      <div class='box-tools pull-right'>
        <a href='$SELF_URL?index=$index&UID=%UID%&add_form=1' class='btn btn-xs btn-success' title='_{ADD_SERVICE}_'>_{ADD_SERVICE}_</a>
    ...
    <div class='nav-tabs-custom box-body'>
      ...
      <div class='box box-default box-big-form collapsed-box'>
        ...
        <div class='box-body'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-3 pull-left'>CPE MAC</label>
            <div class='col-md-9'>
              <input type='text' class='form-control' name='CPE_MAC' value='%CPE_MAC%'>
            </div>
          </div>
          ...
          <div class='form-group'>
            ...
            <div class='col-md-9'>
              <span class='label label-primary'>111 %ID%</span>
            </div>
          </div>
