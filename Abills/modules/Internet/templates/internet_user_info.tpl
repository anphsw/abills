...
<div class='box box-theme'>
    <div class='box-header with-border text-center'><h4 class='box-title'>_{INTERNET}_</h4></div>
        ...
        <div class='panel-body'>
            <div class='table table-striped table-hover'>
                <div class='row'>
                    ...
                    <div class='col-md-9 text-2'>[%TP_NUM%] <b>%TP_NAME%</b> <span class='extra'>%TP_CHANGE% </span> <br>%COMMENTS%
                    </div>
                </div>
