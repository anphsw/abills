...
<tr><td>_{SENT}_ (%TRAFFIC_NAMES_0%):</td><td align=right>%_SENT% (%RECV%)</td></tr>
<tr><td>_{RECV}_ (%TRAFFIC_NAMES_0%):</td><td  align=right>%_RECV% (%SENT%)</td></tr>
...
<tr class='totle_color'><th colspan=2>_{NAS}_</th></tr>
