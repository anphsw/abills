...
$lang{MAC} = 'MAC-адреса';
$lang{LOADING_DATA_ONTO_THE_MAP} = 'Будь ласка, зачекайте. Йде завантаження даних на карту';
$lang{INTERNET_TARIFF_PLAN_GRADIENTS} = 'Градієнти тарифного плану';
...
$lang{INTERNET_DATA_LOADING_ERROR} = 'Помилка завантаження даних';
$lang{INTERNET_NO_STREETS_IN_THIS_AREA} = 'Немає вулиць у цьому районі';
