...
<div class='row text-left card-row %CARD_SELECTED%'>
    <label class='paysys_card'>
        <div class='col-md-1 text-left float-left card-checkbox-container'>
        ...
        <div class='col-md-11 text-left card-text-container card-selected-highlight'>
            <div class='float-left'><img height='50px' width='50' src='styles/default/img/paysys_logo/credit_card.png'></div>
            <div class='horizontal-centered-del float-right'>
                %DELETE_BUTTON%
            </div>
            <h4>%NAME%</h4>
            <small>%MASK%</small>
