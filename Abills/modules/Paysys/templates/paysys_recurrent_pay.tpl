<div class='card card-primary card-outline'>
  <form id='liqpay_form' method='post' accept-charset='utf-8'>
    ...
    <input type='hidden' name='RECURRENT_FORM' value='1'>
    ...
    <div class='card-body pt-0'>
      <div class='text-center m-1'>
        <img src='/styles/default/img/paysys_logo/%MODULE%-logo.png'
      ...
      <ul class='list-group list-group-unbordered mb-3'>
        <li class='list-group-item'>
          ...
          <div class='float-right'>
            <a class='btn btn-warning' href='%POLICY_URL%'>_{READ_HERE}_</a>
          </div>
        </li>
        <li class='list-group-item'>
          <b>_{SUBSCRIBE}_ %MODULE%</b>
          <div class='float-right'>
            <input type='checkbox'
                   %SUBSCRIBE_DEFAULT%
                   data-return='1'
