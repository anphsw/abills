...
#Web test 12 check
$result = Abills::Fetcher::web_request("https://$url/paysys_check.cgi?ACT=1&PAY_ACCOUNT=$user_id&SERVICE_ID=$service&PAY_ID=$pay_id&SIGN=$sign_check", {
  INSECURE => 1,
});
...
#Web test 13 pay
$result = Abills::Fetcher::web_request("https://$url/paysys_check.cgi?ACT=4&PAY_ACCOUNT=$user_id&SERVICE_ID=$service&PAY_ID=$pay_id&PAY_AMOUNT=1.01&SIGN=$sign_pay", {
  INSECURE => 1,
});
...
my $response = Abills::Fetcher::web_request("https://$url/paysys_check.cgi?ACT=7&PAY_ACCOUNT=$user_id&SERVICE_ID=$service&PAY_ID=$pay_id&SIGN=$sign_confirm", {
  INSECURE => 1,
});
