...
Test::More::use_ok('Abills::Base', qw/mk_unique_value encode_base64 decode_base64/);
...
my $encrypted64 = Abills::Base::encode_base64($cipher->encrypt($json_payment));
# Он же декодированный
my $decrypted = $cipher->decrypt(Abills::Base::decode_base64($encrypted64));
