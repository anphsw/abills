...
do $base_dir . "/Abills/modules/Paysys/lng_$conf{language}.pl";

use Abills::Base qw(check_time mk_unique_value);
Test::More::use_ok('Paysys');
Test::More::use_ok('Paysys::systems::Liqpay');
Test::More::use_ok('Conf');
Test::More::use_ok('Abills::Base', qw/mk_unique_value check_time/);
...
$hold_wait_hash{data} = Abills::Base::encode_base64($requests[0]->{request});
