    ...
    <div class='box box-theme box-big-form'>
        <div class='box-body'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <input id='BEGIN' name='BEGIN' value='%BEGIN%' placeholder='_{BEGIN}_' class='form-control'
                           type='text'>
                </div>
            </div>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <input id='COUNT' name='COUNT' value='%COUNT%' placeholder='_{COUNT}_' class='form-control'
                           type='text'>
                </div>
            </div>
