<form action='%SELF_URL%' METHOD='POST' class='form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-md-3 col-form-label text-md-right' for='EVERY_MONTH'>_{EVERY_MONTH}_:</label>
        <div class='col-md-9'>
          <div class='form-check'>
            <input type='checkbox' class='form-check-input' id='EVERY_MONTH' name='EVERY_MONTH' %EVERY_MONTH% value='1'>
          </div>
        </div>
      </div>
