  ...
  <tr style='vertical-align:top'>
    <td style='width:15em'><table>
	 ...
	 onclick='stopEditing()'/ ></td>
          <td><div id='placemark_b' onclick='placeMarker()' title='_{ADD_HOUSE}_'></td>
          <td><div id='addroute' onclick=\"location.href='index.cgi?index=$index&route=add' \" title=\"_{CREATE_EDIT_ROUTE}_\"/></td>
        </tr>
      </table>
      <p> </p>
