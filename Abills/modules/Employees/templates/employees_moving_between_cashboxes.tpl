<form action='$SELF_URL' METHOD=POST>
  ...
  <div class='card card-primary card-outline container-md'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right required'>_{CASHBOX}_</br>_{COMING}_:</label>
        <div class='col-md-8'>
          %CASHBOX_SELECT_COMING%
        </div>
      </div>
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right required'>_{CASHBOX}_</br>_{SPENDING}_:</label>
        <div class='col-md-8'>
