...
$lang{CAPABILITY} = 'Возможность';

$lang{EQUIPMENT_SCALE_TO_CONTENT} = 'Масштабировать по содержимому';
$lang{EQUIPMENT_ALIGN} = 'Выровнять';
$lang{EQUIPMENT_ADD_NEW_EQUIPMENT} = 'Добавить новое оборудование';
$lang{EQUIPMENT_ADD_PORT_BINDING} = 'Добавить привязку порта';
