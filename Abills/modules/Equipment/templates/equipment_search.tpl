...
<div class='form-group'>
    ...
    <div class='col-sm-9'>
      <input type=text class='form-control' id='SYSTEM_ID' placeholder='%SYSTEM_ID%' name='SYSTEM_ID' value='%SYSTEM_ID%'>
    </div>
</div>
...
<div class='form-group'>
    ...
    <div class='col-sm-9'>
      <input type=text class='form-control' id='FREE_PORTS' placeholder='%FREE_PORTS%' name='FREE_PORTS' value='%FREE_PORTS%'>
    </div>
</div>
...
<div class='form-group'>
    ...
    <div class='col-sm-9'>
      <input type=text class='form-control' id='START_UP_DATE' placeholder='%START_UP_DATE%' name='START_UP_DATE' value='%START_UP_DATE%'>
    </div>
</div>
...
<div class='form-group'>
    ...
    <div class='col-md-9'>
      <input type=text class='form-control' id='COMMENTS' placeholder='%COMMENTS%' name='COMMENTS' value='%COMMENTS%'>
    </div>
</div>
...
<div class='form-group'>
    ...
    <div class='col-md-9'>
      <input type=text class='form-control' id='USER_MAC' placeholder='%USER_MAC%' name='USER_MAC' value='%USER_MAC%'>
    </div>
</div>
