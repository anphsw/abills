<form name='form_setting' id='form_setting' method='post' class='form'>
    ...
    <input type='hidden' name='ONU' value='%ONU%'>
    ...
    <div class='form-group row'>
        <label class='col-sm-2 col-form-label' for='voip_user'>Username:</label>
        <div class='col-sm-3'>
    ...
    <div class='form-group row'>
        <label class='col-sm-2 col-form-label' for='voip_pass'>Password:</label>
        <div class='col-sm-3'>
    ...
    <div class='form-group row'>
        <label class='col-sm-2 col-form-label' for='voip_number'>Number:</label>
        <div class='col-sm-3'>
