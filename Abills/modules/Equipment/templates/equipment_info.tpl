...
<form action='$SELF_URL' METHOD='post' name='equipment_info' class='form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label for='START_UP_DATE' class='col-md-4 col-form-label text-md-right'>_{VERSION}_ SNMP:</label>
        <div class='col-md-8'>
          %SNMP_VERSION_SEL%
        </div>
      </div>
      ...
      <div class='card card-primary card-outline collapsed-card'>
        ...
        <div class='card-body'>
          <div class='form-group row'>
            <label for='REVISION' class='col-md-4 col-form-label text-md-right'>_{REVISION}_:</label>
            <div class='col-md-8'>
          ...
          <div class='form-group row'>
            <label for='FIRMWARE' class='col-md-4 col-form-label text-md-right'>_{FIRMWARE}_:</label>
            <div class='col-md-8'>
          ...
          <div class='form-group row'>
            <label for='SERVER_VLAN' class='col-md-4 col-form-label text-md-right'>SERVER VLAN:</label>
            <div class='col-md-8'>
              %VLAN_SEL%
            </div>
          </div>
          ...
          <div class='form-group row'>
            <label for='INTERNET_VLAN' class='col-md-4 col-form-label text-md-right'>INTERNET VLAN:</label>
            <div class='col-md-8'>
              <input type='text' class='form-control' id='INTERNET_VLAN' placeholder='%INTERNET_VLAN%'
                     name='INTERNET_VLAN'
                     value='%INTERNET_VLAN%'>
            </div>
          </div>
          ...
          <div class='form-group row'>
            <label for='TR_069_VLAN' class='col-md-4 col-form-label text-md-right'>TR-069 VLAN:</label>
            <div class='col-md-8'>
