        ...
        <div class='col-md-6'>
            ...
            <div class='card card-primary card-outline collapsed-card'>
                ...
                <div id='_t3' class='card-body'>
                    ...
                    <div class='form-group row'>
                        <label class='col-md-3 control-label' id='WEEK_TIME_LIMIT'>_{WEEK}_:</label>
                        <div class='col-md-9'>
            ...
            <div class='card card-primary card-outline collapsed-card'>
                ...
                <div id='_t4' class='card-body'>
                    <div class='form-group row'>
                        ...
                        <div class='col-md-9'>
                            <input class='form-control' id='EXTRA_NUMBERS_DAY_FEE' type='text' name=EXTRA_NUMBERS_DAY_FEE value='%EXTRA_NUMBERS_DAY_FEE%'>
                        </div>
                    </div>
                    <div class='form-group row'>
