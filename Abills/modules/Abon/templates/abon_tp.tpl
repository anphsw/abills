    ...
    <div class='box box-form box-theme'>
        ...
        <div class='box-body'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-5'>
                    <input type='checkbox' name='VAT' %VAT% value='1' ID='VAT'/>
                </div>
            </div>
            ...
            <div class='collapse' id='notification'>
                <div class='well'>
                    <div class='form-group'>
                        ...
                        <div class='col-md-2'>
                            <input class='form-control' type='text' name='NOTIFICATION1' value='%NOTIFICATION1%'
                                   maxlength='2'/>
                        </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-2'>
                            <input class='form-control' type='text' name='NOTIFICATION2' value='%NOTIFICATION2%'
                                   maxlength='2'/>
                        </div>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-9'>
                    <textarea rows='2' id='SERVICE_LINK' name='DESCRIPTION'
