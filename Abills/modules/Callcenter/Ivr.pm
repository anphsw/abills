...
$var_dir = '/usr/abills/var/' if (!$var_dir);
...
sub message {
  ...
  my $googletts = ($self->{conf}{CALLCENTER_GOOGLETTS}) ? $self->{conf}{CALLCENTER_GOOGLETTS} : '/usr/abills/Abills/modules/Callcenter/googletts.agi';
