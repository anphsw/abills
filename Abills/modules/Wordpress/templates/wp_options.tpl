  ...
  <div class='box-body'>
    ...
    <form name='WORDPRESS_OPTIONS' id='form_WORDPRESS_OPTIONS' method='post' class='form form-horizontal'>
      ...
      <div class='form-group'>
        ...
        <div class='col-md-7'>
          <input type='text' class='form-control' required name='abills_billing_url' id="ABILLS_BILLING_URL"
                 value='%abills_billing_url%'/>
        </div>
      </div>
      ...
      <fieldset id='coa_params'>
        <div class='form-group'>
          ...
          <div class='col-md-9'>
            <input type='text' class='form-control' name='abills_coa_address' id="ABILLS_COA_ADDRESS"
                   value='%abills_coa_address%'/>
          </div>
        </div>
        <div class="col-md-6">
          <div class='form-group'>
            ...
            <div class='col-md-7'>
              <input type='text' class='form-control' name='abills_coa_work_days' id="ABILLS_COA_WORK_DAYS"
                     value='%abills_coa_work_days%'/>
            </div>
          </div>
          <div class='form-group'>
            <label class='control-label col-md-5' for='BLOG_TAGLINE_ID'>Время работы в рабочие дни</label>
            <div class='col-md-7'>
              <input type='text' class='form-control' name='abills_coa_work_hours' id="ABILLS_COA_WORK_HOURS"
                     value='%abills_coa_work_hours%'/>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class='form-group'>
            <div class='form-group'>
              ...
              <div class='col-md-7'>
                <input type='text' class='form-control' name='abills_coa_holiday_days' id="ABILLS_COA_HOLIDAY_DAYS"
                       value='%abills_coa_holiday_days%'/>
              </div>
            </div>
            <label class='control-label col-md-5' for='BLOG_TAGLINE_ID'>Время работы в выходные</label>
            <div class='col-md-7'>
              <input type='text' class='form-control' name='abills_coa_holiday_hours'
                     id="ABILLS_COA_HOLIDAY_HOURS"
                     value='%abills_coa_holiday_hours%'/>
            </div>
          </div>
        </div>
      ...
      <div class='form-group'>
        ...
        <div class='col-md-7'>
          <input type='text' class='form-control' required name='abills_provider_mail' id="ABILLS_PROVIDER_MAIL"
                 value='%abills_provider_mail%'/>
        </div>
        ...
        <div class='checkbox'>
          <label>
            <input type='checkbox' class='control-element' %ABILLS_SLIDESHOW_ON_CHECKED%
                   name='abills_slideshow_on' value='1' data-return='1'/>
