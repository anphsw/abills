...
<TABLE class=form>
  ...
  <TR>
    <TD>Active</TD>
    <TD><INPUT type=checkbox value=3 name=ACTIVE %ACTIVE%> </TD>
  </TR>
  <TR>
    <TD>Name</TD><TD><INPUT maxLength=32 size=11 name=NAME value='%NAME%'></TD>
  </TR>
  <TR>
  ...
  <TR>
     <TD>VID</TD><TD><INPUT maxLength=4 size=4 name=VLAN value='%VLAN%'> </TD>
  </TR>
  <TR>
