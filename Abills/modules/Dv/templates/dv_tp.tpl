...
<div class='panel-heading text-center'><h4>_{TARIF_PLAN}_</h4></div>
...
<div class='form-group'>
  ...
  <div class='col-md-9'>
      <input id='SIMULTANEOUSLY' name='SIMULTANEOUSLY' value='%SIMULTANEOUSLY%' placeholder='%SIMULTANEOUSLY%' class='form-control' type='text'>
    </div>
   </div>
...
<div id='abon_misc' class='panel-collapse collapse out'>
...
<div class='panel-body'>
 ...
 <div class='form-group'>
  ...
  <div class='col-md-9'>
    <input id='POSTPAID_MONTH_FEE' name='POSTPAID_MONTH_FEE' value='1' %POSTPAID_MONTH_FEE% type='checkbox'>
  </div>
   </div>
...
<div id='_time_limit' class='panel-collapse collapse out'>
...
<div class='panel-body'>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='DAY_TIME_LIMIT' placeholder='%DAY_TIME_LIMIT%' name='DAY_TIME_LIMIT' value='%DAY_TIME_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='WEEK_TIME_LIMIT' placeholder='%WEEK_TIME_LIMIT%' name='WEEK_TIME_LIMIT' value='%WEEK_TIME_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='MONTH_TIME_LIMIT' placeholder='%MONTH_TIME_LIMIT%' name='MONTH_TIME_LIMIT' value='%MONTH_TIME_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='TOTAL_TIME_LIMIT' placeholder='%TOTAL_TIME_LIMIT%' name='TOTAL_TIME_LIMIT' value='%TOTAL_TIME_LIMIT%'>
    </div>
  </div>
</div>
 </div>
...
<div id='_traf_limit' class='panel-collapse collapse out'>

<div class='panel-body'>
   <div class='form-group'>
    <label for='DAY_TRAF_LIMIT' class='control-label col-sm-3'>_{DAY}_:</label>
    <div class='col-md-9'>
      <input class='form-control' id='DAY_TRAF_LIMIT' placeholder='%DAY_TRAF_LIMIT%' name='DAY_TRAF_LIMIT' value='%DAY_TRAF_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='WEEK_TRAF_LIMIT' placeholder='%WEEK_TRAF_LIMIT%' name='WEEK_TRAF_LIMIT' value='%WEEK_TRAF_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='MONTH_TRAF_LIMIT' placeholder='%MONTH_TRAF_LIMIT%' name='MONTH_TRAF_LIMIT' value='%MONTH_TRAF_LIMIT%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='TOTAL_TRAF_LIMIT' placeholder='%TOTAL_TRAF_LIMIT%' name='TOTAL_TRAF_LIMIT' value='%TOTAL_TRAF_LIMIT%'>
    </div>
  </div>
  </div class='panel-body'>
 </div>
...
<div id='_other' class='panel-body panel-collapse collapse out'>
  ...
  <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' type='text' id='ACTIV_PRICE' placeholder='%ACTIV_PRICE%' name='ACTIV_PRICE' value='%ACTIV_PRICE%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='CHANGE_PRICE' placeholder='%CHANGE_PRICE%' name='CHANGE_PRICE' value='%CHANGE_PRICE%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='CREDIT_TRESSHOLD' placeholder='%CREDIT_TRESSHOLD%' name='CREDIT_TRESSHOLD' value='%CREDIT_TRESSHOLD%'>
    </div>
  </div>
  ...
  <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='USER_CREDIT_LIMIT' placeholder='%USER_CREDIT_LIMIT%' name='USER_CREDIT_LIMIT' value='%USER_CREDIT_LIMIT%'>
    </div>
  </div>

  <div class='form-group'>
    <label for='MAX_SESSION_DURATION' class='control-label col-sm-3'>_{MAX_SESSION_DURATION}_ (sec.):</label>
    <div class='col-md-9'>
      <input class='form-control' id='MAX_SESSION_DURATION' placeholder='%MAX_SESSION_DURATION%' name='MAX_SESSION_DURATION' value='%MAX_SESSION_DURATION%'>
    </div>
  </div>
  ...
  <div class='form-group'>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='MIN_SESSION_COST' placeholder='%MIN_SESSION_COST%' name='MIN_SESSION_COST' value='%MIN_SESSION_COST%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='TRAFFIC_TRANSFER_PERIOD' placeholder='%TRAFFIC_TRANSFER_PERIOD%' name='TRAFFIC_TRANSFER_PERIOD' value='%TRAFFIC_TRANSFER_PERIOD%'>
    </div>
  </div>
   ...
   <div class='form-group'>
    ...
    <div class='col-md-9'>
      <input class='form-control' id='NEG_DEPOSIT_FILTER_ID' placeholder='%NEG_DEPOSIT_FILTER_ID%' name='NEG_DEPOSIT_FILTER_ID' value='%NEG_DEPOSIT_FILTER_ID%'>
    </div>
  </div>
