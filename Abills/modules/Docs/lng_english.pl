...
$lang{ERR_DOCUMENT_HAS_ALREADY_BEEN_SENT} = 'The document has already been sent.';
$lang{ERR_SEND_DOCUMENT} = 'Failed to send the document.';
...
$lang{DOCS_DOWNLOAD_FOR_E_SIGN} = 'Download for electronic signature';
...
$lang{INCOMING_DOCUMENTS} = 'Incoming documents';
$lang{OUTGOING_DOCUMENTS} = 'Outgoing documents';
