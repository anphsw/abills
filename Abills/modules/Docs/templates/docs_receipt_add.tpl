<form action='$SELF_URL' method='post' name='invoice_add'>
    ...
    <div class='card container-md'>
        ...
        <div class='card-body form-horizontal'>
            ...
            <div class="form-group row">
                <label class="control-label col-sm-12 col-md-3" for='CURENT_BILLING_PERIOD'>_{CURENT_BILLING_PERIOD}_:</label>
                <div class="col-sm-12 col-md-9">
                    <div class='input-group'>
                        <input type='text' readonly id='CUSTOMER' name='CUSTOMER'
                            value='%CURENT_BILLING_PERIOD_START% - %CURENT_BILLING_PERIOD_STOP%' placeholder='%CUSTOMER%'
                            class='form-control'>
                    </div>
                </div>
            </div>
            ...
            <div class='form-group'>
                <div class="custom-control custom-radio">
                    <input class="custom-control-input"  type="radio" value="0" id="INCLUDE_CUR_BILLING_PERIOD1" name="INCLUDE_CUR_BILLING_PERIOD">
                    <label for="INCLUDE_CUR_BILLING_PERIOD1" class="custom-control-label">_{INCLUDE_CUR_BILLING_PERIOD}_ </label>
                </div>
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" value="1" id="INCLUDE_CUR_BILLING_PERIOD2" name="INCLUDE_CUR_BILLING_PERIOD">
