    ...
    <div class='box-body'>
        ...
        <form name='DOCS_REGISTRATION' id='form_DOCS_REGISTRATION' method='post' class='form form-horizontal'>
            ...
            <div class='form-group'>
                <label class='control-label col-md-3' for='NAME_id'>_{NAME}_ _{COMPANY}_</label>
                <div class='col-md-9'>
            ...
            <div class='form-group'>
                <label class='control-label col-md-3' for='HEADER_id'>_{HEADER}_</label>
                <div class='col-md-9'>
            ...
            <div class='form-group'>
                <label class='control-label col-md-3' for='TEXT_id'>_{TEXT}_</label>
                <div class='col-md-9'>
...
<div class='row'>
    <a class='btn btn-success'
       href='/admin/index.cgi?get_index=form_templates&header=1&new_editor=1&create=Docs:docs_registration.tpl'
