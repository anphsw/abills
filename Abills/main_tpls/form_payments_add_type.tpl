  ...
  <div class='card card-primary card-outline card-form'>
    ...
    <div class='card-body'>
      ...
      <div class="form-group row">
        <label class='col-md-4 control-label' for='NEW_ID'>ID:</label>
        <div class='col-md-8'>
      ...
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right' for='DEFAULT_PAYMENT'>_{DEFAULT}_:</label>
        <div class='col-md-8'>
          <div class='form-check'>
            <input type='checkbox' class='form-check-input' id='DEFAULT_PAYMENT'
                   name='DEFAULT_PAYMENT' %CHECK_DEFAULT% value='1' data-tooltip='%ADMIN_PAY%'>
          </div>
        </div>
      </div>
...
<!--      </div>-->
    ...
    <div class='card-footer'>
      <input class='btn btn-primary pull-center' name='%BUTTON_LABEL%' value='%BUTTON_NAME%' type='submit'>
    </div>
