  ...
  <div class='card card-primary card-outline container-md'>
    ...
    <div class='card-body'>
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right required' for='UID'>_{DISCARD}_ (UID):</label>
        <div class='col-md-4'><input type=text id='UID' name=UID value='%UID%' class='form-control' required> </div>
      </div>
      <div class='form-group row'>
