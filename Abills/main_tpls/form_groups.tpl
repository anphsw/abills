  ...
  <fieldset>
    <div class='box box-theme box-form'>
      <div class='box-header with-border'>
        <h4 class='box-title'>_{GROUPS}_</h4></div>
      <div class='box-body'>

        <div class='form-group'>
          <label class='control-label col-md-3 required' for='GID'>GID:</label>
          <div class='col-md-9'>
            <input id='GID' name='GID' value='%GID%' required placeholder='%GID%' class='form-control' type='text' %GID_DISABLE%>
          </div>
        </div>
        ...
        <div class='form-group'>
          <label class='control-label col-md-6' for='DISABLE_PAYMENTS'>_{DISABLE}_ _{PAYMENTS}_ _{CASHBOX}_</label>
          <div class='col-md-2'>
            <input id='DISABLE_PAYMENTS' name='DISABLE_PAYMENTS' value='1' %DISABLE_PAYMENTS% type='checkbox'>
          </div>
        </div>
