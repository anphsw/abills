...
<form action='%SELF_URL%' METHOD='POST' class='form form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form %PROFILE_HIDDEN%'>
  ...
  <div class='abills-form-main-buttons pb-3 card-footer %DEFAULT_BUTTONS_HIDDEN% container-md'>
    <input type='submit' id='default' name='default' value='_{DEFAULT}_' class='btn btn-secondary'/>
    <input type='submit' id='set' name='set' value='_{SET}_' class='btn btn-primary'/>
  </div>
</form>
...
<!--card-form-->
<div class='card card-teal card-outline %SUBSCRIBE_BLOCK_HIDDEN%'>
  <div class='card-header border-0'>
    <h2 class='card-title'>_{BOTS}_ </h2>
  </div>
