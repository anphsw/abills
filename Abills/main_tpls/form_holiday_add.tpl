<form action=%SELF_URL% name='holiday' id='form_holiday' method='post'>
    ...
    <div class='card card-primary card-outline box-form'>
        ...
        <div class='card-body'>
            ...
            <div class='form-group row'>
                ...
                <div class='col-md-9'>
                    <input type='text' class='form-control' required name='MONTH' id='MONTH_id' value='%MONTH%'
                           readonly>
                </div>
            </div>
        ...
        <div class='card-footer'>
            <input type='submit' form='form_holiday' class='btn btn-primary' name='%ACTION%' value='%ACTION_LNG%'>
        </div>
