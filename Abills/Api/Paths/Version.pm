  ...
  return [
    {
      method      => 'GET',
      path        => '/version/',
      controller  => 'Api::Controllers::Admin::Version',
      endpoint    => \&Api::Controllers::Admin::Version::get_version,
      credentials => [
        'ADMIN', 'ADMINSID', 'ADMINBOT', 'USER', 'USERBOT'
      ]
    }
  ];
}
