...
CREATE TABLE IF NOT EXISTS `admin_actions` (
  ...
  KEY `module_type` (`module`, `action_type`)
)
...
CREATE TABLE IF NOT EXISTS `admins` (
  `id`               VARCHAR(20)          NOT NULL DEFAULT '' COMMENT 'Admin login',
  `name`             VARCHAR(80)          NOT NULL DEFAULT '',
  `position`         SMALLINT UNSIGNED    NOT NULL DEFAULT 0,
  `regdate`          DATE                 NOT NULL,
  `password`         BLOB                 NOT NULL,
  `password_changed_at` DATE              NOT NULL DEFAULT '0000-00-00',
  `gid`              SMALLINT(4) UNSIGNED NOT NULL DEFAULT '0',
  `aid`              SMALLINT(6) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Admin ID',
  ...
  `pasport_expire`   DATE                 NOT NULL DEFAULT '0000-00-00',
  ...
  `availability_period` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `id` (`id`),
  KEY `domain_id` (`domain_id`),
  KEY `sip_number` (`sip_number`),
  KEY `gid` (`gid`),
...
CREATE TABLE IF NOT EXISTS `companies` (
  ...
  `contract_id`      VARCHAR(100)          NOT NULL DEFAULT '',
  ...
  `indication`       VARCHAR(200)          NOT NULL DEFAULT '' COMMENT 'Contract indication',
  `contract_expiry`  DATE                  NOT NULL DEFAULT '0000-00-00',
  `contract_status`  TINYINT(1)  UNSIGNED  NOT NULL DEFAULT 0,
  `payment_type`     TINYINT(1)  UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'Contract payment type',
  PRIMARY KEY (`id`),
  KEY `bill_id` (`bill_id`),
...
CREATE TABLE IF NOT EXISTS `docs_invoices` (
  ...
  `tracking_date_to`     DATE             NOT NULL,
  `tracking_number_to`   VARCHAR(100)     NOT NULL DEFAULT '',
  `receive_date`         DATE             NOT NULL,
  `tracking_date_from`   DATE             NOT NULL,
  `tracking_number_from` VARCHAR(100)     NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `fees` (
  ...
  `method`         SMALLINT(6) UNSIGNED  NOT NULL  DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `info_fields` (
  ...
  `parent_value_id` SMALLINT   UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `internet_online` (
  ...
  `dhcp_id`                    TINYINT(1)  UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ippools` (
  ...
  `ip`               INT(10) UNSIGNED     NOT NULL DEFAULT '0' COMMENT 'IPv4 START IP',
  `counts`           INT(10) UNSIGNED     NOT NULL DEFAULT '0' COMMENT 'IPv4 IP count in pool',
  `name`             VARCHAR(80)          NOT NULL DEFAULT '',
  `priority`         TINYINT(4) UNSIGNED  NOT NULL DEFAULT '0',
  `static`           TINYINT(1) UNSIGNED  NOT NULL DEFAULT '0' COMMENT 'For static assign only',
  `speed`            INT(10) UNSIGNED     NOT NULL DEFAULT '0',
  `ipv6_prefix`      VARBINARY(16)        NOT NULL DEFAULT '',
  `ipv6_net_mask`    TINYINT(1) UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'IPv6 Network mask',
  `ipv6_mask`        TINYINT(1) UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'IPv6 User mask',
  `ipv6_template`    VARBINARY(100)       NOT NULL DEFAULT '',
  `ipv6_pd`          VARBINARY(16)        NOT NULL DEFAULT '',
  `ipv6_pd_net_mask` TINYINT(1) UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'IPv6 PD Network mask',
  `ipv6_pd_mask`     TINYINT(1) UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'IPv6 PD User mask',
  `ipv6_pd_template` VARBINARY(100)       NOT NULL DEFAULT '',
  `next_pool_id`     SMALLINT(6) UNSIGNED NOT NULL DEFAULT 0,
  `netmask`          INT(11) UNSIGNED     NOT NULL DEFAULT '4294967295' COMMENT 'IPv4 Netmask for dynamic user assign',
...
CREATE TABLE IF NOT EXISTS `msgs_admins` (
  ...
  UNIQUE KEY `aid_chapter_id` (`aid`, `chapter_id`),
  KEY `aid` (`aid`),
...
(
    ...
    `location_id`        INT(11) UNSIGNED     NOT NULL DEFAULT 0,
    `external_chat_id`   INT(11) UNSIGNED     NOT NULL DEFAULT 0,
    `domain_id`          SMALLINT(6) UNSIGNED NOT NULL DEFAULT 0,
    ...
    `client_responsible` VARCHAR(60)          NOT NULL DEFAULT '',
    PRIMARY KEY (`id`),
    KEY `aid` (`aid`),
    KEY `resposible` (`resposible`),
    KEY `uid` (`uid`),
    KEY `chapter` (`chapter`),
    KEY `external_chat_id` (`external_chat_id`),
    KEY `state` (`state`),
    KEY `dispatch_id` (`dispatch_id`),
    KEY `closed_aid` (`closed_aid`),
    KEY `domain_id` (`domain_id`),
    KEY `gid` (`gid`),
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `ext_id`         VARCHAR(50)          NOT NULL  DEFAULT '',
  `bill_id`        INT(11) UNSIGNED     NOT NULL  DEFAULT '0',
  `inner_describe` VARCHAR(80)          NOT NULL  DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `shedule` (
  ...
  `service_id`   INT(11) UNSIGNED     NOT NULL DEFAULT '0' COMMENT 'MODULE Service ID',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tarif_plans` (
  ...
  `age_alignment`           TINYINT(2) UNSIGNED    NOT NULL DEFAULT '0',
  ...
  `gid`                     SMALLINT(6) UNSIGNED   NOT NULL DEFAULT '0',
  `neg_deposit_filter_id`   VARCHAR(240)           NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `users_pi` (
  ...
  `contract_expiry`DATE                 NOT NULL DEFAULT '0000-00-00',
  `contract_status`TINYINT(1) UNSIGNED  NOT NULL DEFAULT 0,
  `indication`     VARCHAR(200)         NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `users_pi_docs` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  UNIQUE KEY `doc_type_num` (`doc_type`, `num`)
)
  DEFAULT CHARSET = utf8
...
CREATE TABLE IF NOT EXISTS `districts` (
  ...
  `population` INT UNSIGNED        NOT NULL DEFAULT 0,
  `households` INT UNSIGNED        NOT NULL DEFAULT 0,
  `territorial_units_id` INT UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `idx_path` (`path`),
...
CREATE TABLE IF NOT EXISTS `builds` (
  ...
  `start_numbering_floor`TINYINT(4)          NOT NULL DEFAULT 1,
...
REPLACE INTO `admin_type_permits` (`type`, `section`, `actions`, `module`) VALUES
  ...
  ('$lang{ALL} $lang{PERMISSION}', 0, 41, ''),
  ('$lang{ALL} $lang{PERMISSION}', 0, 42, ''),
  ('$lang{ALL} $lang{PERMISSION}', 1, 0, ''),
  ('$lang{ALL} $lang{PERMISSION}', 1, 1, ''),
  ('$lang{ALL} $lang{PERMISSION}', 1, 2, ''),
  ('$lang{ALL} $lang{PERMISSION}', 1, 3, ''),
  ...
  ('$lang{ALL} $lang{PERMISSION}', 7, 10, ''),
  ('$lang{ALL} $lang{PERMISSION}', 7, 11, ''),
  ('$lang{ALL} $lang{PERMISSION}', 7, 12, ''),
...
INSERT INTO `users_pi` (`uid`, `fio`, `comments`, `reg_address`) VALUES (1, 'Test user', '', '');
...
INSERT INTO `ippools` (`id`, `nas`, `ip`, `counts`, `name`, `priority`, `comments`) VALUES (1, 1, 167772161, 256, 'Main', 0, '');

INSERT INTO `nas_ippools` (`pool_id`, `nas_id`) VALUES (1, 1);
INSERT INTO `msgs_chapters` (`name`) VALUES ('-');

REPLACE INTO `fees_types` (`id`, `name`)
VALUES (1, '$lang{ABON}'),
       (2, '$lang{FINE}'),
       (3, '$lang{ACTIVATE}'),
       (4, '$lang{MONEY_TRANSFER}'),
       (5, '$lang{CREDIT}'),
       (0, '$lang{ONE_TIME}');
...
CREATE TABLE `admin_group_templates` (
  `type` varchar(60)         NOT NULL DEFAULT '',
  `gid` smallint(6) unsigned NOT NULL DEFAULT '0',
  KEY `gid` (`gid`)
)
  DEFAULT CHARSET = utf8
  COMMENT = 'Admin group type permits';
