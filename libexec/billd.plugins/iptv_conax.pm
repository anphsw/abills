...
sub get_status {
  ...
  foreach my $service (@$services) {
    ...
    foreach my $user (@$users_) {
      ...
      my $result_get = $ftp->get($file_name, "/usr/abills/Abills/modules/Iptv/Conax/$file_name");
...
sub _additional_cards {
  ...
  foreach my $filter (@filter_ids) {
    ...
    open(FILE, ">", "/usr/abills/Abills/modules/Iptv/Conax/$file_name") or die "Couldn't open: $!";
