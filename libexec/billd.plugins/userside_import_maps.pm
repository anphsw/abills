...
sub import {
  ...
  my $us_link      = $conf{USERSIDE_API_URL}  || $argv->{URL} || 'http://demo.userside.eu';
  my $us_apikey    = $conf{USERSIDE_API_KEY} || 'keyus';
  my $us_cat       = $conf{USERSIDE_CAT}    || 'node';
