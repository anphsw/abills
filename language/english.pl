...
$lang{ERR_WRONG_DATE} = 'Date is not valid. Not allowed value of date - %DATE%';
...
$lang{RULES} = 'Rules';
$lang{DEAR} = 'Dear';
$lang{USER_AGREEMENT} = 'You agree to the terms of use of our services';
$lang{WRITE_RULES_HERE} = 'Write the rules here';
$lang{ACCEPT} = 'Accept';
$lang{CANCEL} = 'Cancel';
...
$lang{SN_ADDED} = 'You have successfully added a social network';
...
$lang{BUILDING_STATUSES} = 'Building statuses';
$lang{MASK} = 'Netmask';
...
$lang{ONE_STATUS_DEFAULT} = 'By default, only one status can be selected';
$lang{ERR_SEND_SMS} = 'Failed send sms to phone try later or contact technical support';
$lang{GEO_DISABLED_BY_BROWSER} = 'Geolocation disabled by browser';
$lang{TAKE_SNAPSHOT} = 'Take snapshot';
