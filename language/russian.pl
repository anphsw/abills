...
$lang{PLANNED_EVENTS}='Запланированые мероприятия';
...
$lang{NO_FREE_NEG_POOL_IP} = 'Немає свободного гостевого пула IP';
...
$lang{NEG_FILTER} = 'Гостевий фильтр';
$lang{GUEST} = 'Гость';
$lang{UNKNOWN_SERVER} = 'Неизвестный сервер';
$lang{UNKNOWN_SESSION} = 'Неизвестная сесия';
...
$lang{CHANGE_STATE} = 'Изминение состояния';
$lang{SESSION_SUM} = 'Сумма сесии';
$lang{SESSION_ID} = 'ID сесии';
$lang{UNKNOWN_HANGUP_SESSION} = 'Завершение неизвестной сесии';
