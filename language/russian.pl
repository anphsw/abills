...
$lang{ERR_WRONG_DATE} = 'Неверная дата. Недопустимое значение даты - %DATE%';
$lang{HIGH} = 'Высокий';
$lang{RULES} = 'Правила';
$lang{DEAR} = 'Уважаемый';
$lang{USER_AGREEMENT} = 'Вы соглашаетесь с правилам пользования нашими услугами';
$lang{WRITE_RULES_HERE} = 'Здесь пишите правила';
...
$lang{SN_ADDED} = 'Вы успешно добавили социальную сеть';
...
$lang{COEFFICIENT_OF_DISABLE_USERS} = 'Коэффициент отключенных';
$lang{COEFFICIENT_OF_REQUESTS_USERS} = 'Коэффициент заявок';
$lang{BOTS} = 'Боты';
...
$lang{BUILDING_STATUSES} = 'Статусы зданий';
...
$lang{SUCCESSFULLY_DELETED} = 'Успешно удалено';
$lang{ARCHIVE}='Архив';
$lang{ONE_STATUS_DEFAULT} = 'По умолчанию может быть выбран только один статус';
$lang{ERR_SEND_SMS} = 'Смс сообщение не отправлено, попробуйте позже или обратитесь в техническую поддержку';
$lang{GEO_DISABLED_BY_BROWSER} = 'Геолокация отключена браузером';
$lang{TAKE_SNAPSHOT} = 'Сделать снимок';
...
$lang{INDICATION} = 'Признак';
$lang{EXPIRY} = 'Срок действия';
$lang{WAS_CLOSED} = 'Закрыто';
$lang{ADVANCE} = 'Аванс';
$lang{COMPANY_NAME} = "Название компании";
$lang{REWRITE} = 'Перезаписать';
