package Abills::Backend::Plugin::Android;
use strict;
...
my $log_file = $conf{ANDROID_LOG} || (($base_dir || '/usr/abills') . '/var/log/android_push.log');
my $debug = $conf{ANDROID_DEBUG} || 3;
my $Log = Abills::Backend::Log->new('FILE', $debug, 'Android push notification', { FILE => $log_file });
