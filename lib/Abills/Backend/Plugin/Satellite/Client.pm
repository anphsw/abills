package Abills::Backend::Plugin::Satellite::Client;
use strict;
use warnings FATAL => 'all';

=head1 NAME

  Abills::Backend::Plugin::Satellite::Client - 
...
#**********************************************************
=head2 new($attr) - constructor for Abills::Backend::Plugin::Satellite::Client
  ...
  Returns:
    object - new Abills::Backend::Plugin::Satellite::Client instance
...
sub init {
  ...
  $self->{api} = Abills::Backend::API->new($self->{conf}, {
...
sub request_services_to_check {
  ...
  my Abills::Backend::API $api = $self->{api};
