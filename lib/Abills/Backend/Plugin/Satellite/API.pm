package Abills::Backend::Plugin::Satellite::API;
use strict;
use warnings FATAL => 'all';

=head1 NAME

  Abills::Backend::Plugin::Satellite::API
...
use base 'Abills::Backend::Plugin::BaseAPI';
use Abills::Backend::Plugin::Satellite::Server;
...
sub process_internal_message {
  ...
  #  }
    ...
    my Abills::Backend::Plugin::Satellite::Server $server = $control_plugin->{server};
