...
my @test_list = (
  # https://demo.abills.net.ua:9443/index.cgi?user=testuser&passwd=testuser&json=1
  {
    name       => 'MAIN_MENU',
    params     => {
      json => 1,
  ...
  # https://demo.abills.net.ua:9443/index.cgi?user=testuser&passwd=testuser&json=1&get_index=form_info
  {
    name       => 'FORM_INFO',
    params     => {
      get_index => 'form_info',
  ...
  # https://demo.abills.net.ua:9443/index.cgi?get_index=internet_user_info&del=1&ID=&COMMENTS=test
  {
    name       => 'ACTIVE_SERVICE',
    params     => {
      get_index => 'internet_user_info',
  ...
  # https://demo.abills.net.ua:9443/index.cgi?index=44&user=test&passwd=123456&UID=&ID=8254&FROM_DATE=2019-09-01&TO_DATE=2100-01-01&ACCEPT_RULES=1&add=Приостановление
  {
  ...
  # https://demo.abills.net.ua:9443/index.cgi?get_index=internet_user_chg_tp&ID=&user=test&passwd=123456
  {
    name       => 'CHG_TARIFF',
    params     => {
      get_index => 'internet_user_chg_tp',
  ...
  # https://demo.abills.net.ua:9443/index.cgi?get_index=paysys_user_log&user=test&passwd=123456&json=1
  {
    name       => 'PAYSYS_LOG',
    params     => {
  ...
  # https://demo.abills.net.ua:9443/index.cgi?get_index=paysys_user_log&info=506&json=1&user=test&passwd=123456
  {
